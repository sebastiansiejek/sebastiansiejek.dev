...
function Sheet({ ...properties }: SheetPrimitive.Root.Props) {
  return <SheetPrimitive.Root data-slot="sheet" {...properties} />
}

function SheetTrigger({ ...properties }: SheetPrimitive.Trigger.Props) {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...properties} />
}

function SheetClose({ ...properties }: SheetPrimitive.Close.Props) {
  return <SheetPrimitive.Close data-slot="sheet-close" {...properties} />
}

function SheetPortal({ ...properties }: SheetPrimitive.Portal.Props) {
  return <SheetPrimitive.Portal data-slot="sheet-portal" {...properties} />
}

function SheetOverlay({ className, ...properties }: SheetPrimitive.Backdrop.Props) {
  return (
...
function SheetTitle({ className, ...properties }: SheetPrimitive.Title.Props) {
  return (

...
import { PortfolioContainer } from './PortfolioShell'
...
export async function PortfolioHeader({
  ...
  return (
    <header className="sticky top-0 z-20 h-[72px] border-b border-portfolio-accent/15 bg-portfolio-bg/90 backdrop-blur-2xl max-md:h-16 [@media(prefers-reduced-transparency:reduce)]:bg-portfolio-bg [@media(prefers-reduced-transparency:reduce)]:backdrop-filter-none">
      <PortfolioContainer className="flex h-full items-center justify-between gap-8">
        <Link
        ...
        >
          <span
            className="grid size-9 place-items-center rounded-lg bg-portfolio-accent font-mono text-[0.8rem] font-medium text-[#101411]"
            aria-hidden="true"
          >
            SS
          </span>

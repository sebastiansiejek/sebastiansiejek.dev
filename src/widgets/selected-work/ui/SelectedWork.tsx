            ...
            return (
              ...
              >
                {project.image ? (
                  ...
                  <LocalizedLink
                    className="relative flex aspect-16/10 h-auto flex-wrap place-items-center justify-center gap-4 overflow-hidden rounded-xl bg-[linear-gradient(135deg,transparent_0_44%,rgb(119_217_184/0.09)_44%_56%,transparent_56%),var(--color-portfolio-surface-strong)] font-mono text-portfolio-accent no-underline after:pointer-events-none after:absolute after:inset-0 after:ring-1 after:ring-inset after:ring-portfolio-text/8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-portfolio-accent focus-visible:ring-offset-2 focus-visible:ring-offset-portfolio-bg max-md:aspect-[4/3]"
                    href={{
                      pathname: '/projects/[slug]',
                      params: { slug: key },
                    }}

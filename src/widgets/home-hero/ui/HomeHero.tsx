...
export async function HomeHero({ locale }: { locale: Locale }) {
  ...
  return (
    <section aria-labelledby="hero-title">
      <SiteContainer className="grid min-h-[calc(70dvh-72px)] grid-cols-[minmax(0,1.65fr)_minmax(280px,0.85fr)] items-center gap-[clamp(2rem,4vw,5rem)] pt-[clamp(1rem,5vh,3rem)] max-lg:grid-cols-[minmax(0,1.4fr)_minmax(250px,0.6fr)] max-lg:gap-8 max-md:grid-cols-1 max-md:gap-6 max-md:pt-10">
